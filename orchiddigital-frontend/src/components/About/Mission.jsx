                  ...
                  <div   className="col-md-6 col-sm-6 ">
                    <div className="thumbnail">
                      ...
                      <div className="caption">
                        <h4 className="text-white"> To improve rural livelihoods and sustainable food system in the globe and sustainable e-commerce eco-system..</h4>
